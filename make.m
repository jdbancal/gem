...
%    /usr/bin/g++ -pthread -Wl,--no-undefined  -shared -O -Wl,--version-script,"/opt/MATLAB/R2016a/extern/lib/glnxa64/mexFunction.map" /tmp/mex_5920715111474_21812/gem_mex.o /tmp/mex_5920715111474_21812/gem.o /tmp/mex_5920715111474_21812/utils.o   -lmpfr  -lgmp   -Wl,-rpath-link,/opt/MATLAB/R2016a/bin/glnxa64 -L"/opt/MATLAB/R2016a/bin/glnxa64" -lmx -lmex -lmat -lm -lstdc++ -o gem_mex.mexa64
	...
	flags(4) = unix('/usr/bin/g++ -c -D_GNU_SOURCE -DMATLAB_MEX_FILE  -Isrc/eigen -Isrc/eigen/unsupported -Ieigen -Ieigen/unsupported -I/usr/include  -I"/opt/MATLAB/R2016a/extern/include" -ansi -fexceptions -fPIC -fno-omit-frame-pointer -std=c++11 -O3 -DEIGEN_NO_DEBUG -DNDEBUG src/sgem.cpp -o sgem.o');
	flags(5) = unix('/usr/bin/g++ -c -D_GNU_SOURCE -DMATLAB_MEX_FILE  -Isrc/eigen -Isrc/eigen/unsupported -Ieigen -Ieigen/unsupported -I/usr/include  -I"/opt/MATLAB/R2016a/extern/include" -ansi -fexceptions -fPIC -fno-omit-frame-pointer -std=c++11 -O3 -DEIGEN_NO_DEBUG -DNDEBUG src/sgem_mex.cpp -o sgem_mex.o');
	flags(6) = unix('/usr/bin/g++ -Wl,--no-undefined  -shared -Wl,--version-script,"/opt/MATLAB/R2016a/extern/lib/glnxa64/mexFunction.map" gem_mex.o gem.o sgem.o utils.o   -lmpfr  -lgmp   -Wl,-rpath-link,/opt/MATLAB/R2016a/bin/glnxa64 -L"/opt/MATLAB/R2016a/bin/glnxa64" -lmx -lmex -lmat -lm -lstdc++ -O3 -DEIGEN_NO_DEBUG -o gem_mex.mexa64');
...
elseif v >= 7.11
    ...
    flags(4) = unix('g++ -c  -Isrc/eigen -Isrc/eigen/unsupported -Ieigen -Ieigen/unsupported -I/usr/include -I/opt/MATLABR2010b/extern/include -I/opt/MATLABR2010b/simulink/include -DMATLAB_MEX_FILE -ansi -D_GNU_SOURCE -fPIC -fno-omit-frame-pointer -pthread -O3 -DEIGEN_NO_DEBUG -DNDEBUG -fopenmp src/sgem.cpp');
    flags(5) = unix('g++ -c  -Isrc/eigen -Isrc/eigen/unsupported -Ieigen -Ieigen/unsupported -I/usr/include -I/opt/MATLABR2010b/extern/include -I/opt/MATLABR2010b/simulink/include -DMATLAB_MEX_FILE -ansi -D_GNU_SOURCE -fPIC -fno-omit-frame-pointer -pthread -O3 -DEIGEN_NO_DEBUG -DNDEBUG -fopenmp src/sgem_mex.cpp');
    flags(6) = unix('g++ -pthread -shared -Wl,--version-script,/opt/MATLABR2010b/extern/lib/glnxa64/mexFunction.map -Wl,--no-undefined gem_mex.o gem.o sgem.o utils.o  -lmpfr -lgmp -Wl,-rpath-link,/opt/MATLABR2010b/bin/glnxa64 -L/opt/MATLABR2010b/bin/glnxa64 -lmx -lmex -lmat -lm -O3 -DEIGEN_NO_DEBUG -fopenmp -o gem_mex.mexa64');

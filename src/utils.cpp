...
//    cout << endl << x.toDouble() << endl;
    ...
    int numberPower1(iszero(x) ? 0 : mpfr::mpreal::toLong(mpfr::floor(mpfr::log10(mpfr::abs(x)))));
...
//    cout << endl << x.toDouble() << endl;
    ...
    int exponent(iszero(x) ? 0 : mpfr::mpreal::toLong(mpfr::floor(mpfr::log10(mpfr::abs(x)))));
